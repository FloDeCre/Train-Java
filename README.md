Exercice : Gestionnaire de commandes Tu travailles pour une petite boutique en ligne. On te demande de créer un script Python qui aide à gérer les commandes des clients.
